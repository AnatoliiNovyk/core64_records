...
- when strict policy fails on pooler sslmode, CI logs include a copy-ready `gcloud secrets versions add` remediation command (still fails fast; no policy relaxation)
