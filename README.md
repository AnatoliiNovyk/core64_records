...
- pre-smoke deploy gate runs strict DB route compatibility verdict (`scripts/print-cloud-run-db-route-verdict.mjs --strict`) to fail fast on connector/egress mismatches
...
- pre-smoke rollback gate runs strict DB route compatibility verdict (`scripts/print-cloud-run-db-route-verdict.mjs --strict`) before retries
