...
Write-Host "[1/16] Validating release owner assignments..."
...
Write-Host "[2/16] Validating changelog coverage..."
...
Write-Host "[3/16] Validating changelog format..."
