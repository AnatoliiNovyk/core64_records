...
Write-Host "[1/19] Validating release owner assignments..."
...
Write-Host "[2/19] Validating changelog coverage..."
...
Write-Host "[3/19] Validating changelog format..."
...
Write-Host "[16/19] Running smoke check..."
