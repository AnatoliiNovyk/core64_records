...
async function seed() {
  ...
  await pool.query(
    "INSERT INTO settings (title, about, mission, email) VALUES ($1, $2, $3, $4) ON CONFLICT DO NOTHING",
    [
      "CORE64 Records",
  ...
  await pool.query(
    "INSERT INTO releases (title, artist, genre, year, image, link, ticket_link) VALUES ($1, $2, $3, $4, $5, $6, $7) ON CONFLICT DO NOTHING",
    ["Neural Network", "Cybernetic", "Neurofunk", "2024", "http://static.photos/technology/640x360/1", "#", ""]
  );
