...
async function upsertAdminSettings(queryable, payload) {
  ...
  try {
    await queryable.query(
      ...
      header_logo_url = $9,
      footer_logo_url = $10,
      contact_captcha_enabled = $11,
      contact_captcha_active_provider = $12,
      contact_captcha_hcaptcha_site_key = $13,
      contact_captcha_hcaptcha_secret_key = $14,
      contact_captcha_recaptcha_site_key = $15,
      contact_captcha_recaptcha_secret_key = $16,
      contact_captcha_error_message = $17,
      contact_captcha_missing_token_message = $18,
      contact_captcha_invalid_domain_message = $19,
      contact_captcha_allowed_domain = $20,
      audit_latency_good_max_ms = $21,
      audit_latency_warn_max_ms = $22,
      updated_at = NOW()
